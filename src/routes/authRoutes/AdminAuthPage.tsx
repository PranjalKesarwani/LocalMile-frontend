      ...
      <div className=" w-full h-full flex flex-col items-center justify-center p-10  max-w-[1700px] bg-[#eceff8] ">
        <div className=" flex flex-col items-center justify-center   p-3   rounded-lg w-[35rem] h-[35rem] shadow-lg">
          <form
            ...
            className="flex flex-col items-start justify-center p-3 gap-8 w-full"
          >
            <h1 className="text-center text-2xl  w-full">For Owner of App</h1>
            <label className="w-full flex flex-col gap-1 " htmlFor="phone">
              Phone{" "}
              <input
            ...
            <button
              type="submit"
              className="rounded-lg w-full text-2xl p-2 bg-indigo-600  text-white"
            >
              Log In
            </button>
          </form>
        </div>
        <Link to="/" className="fixed bottom-16 ">
          <span className="text-blue-500 underline">Go Back</span>
        </Link>
      </div>
    </div>
  );
